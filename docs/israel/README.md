...
| Doc | Purpose |
|---|---|
| [INTEGRATIONS.md](./INTEGRATIONS.md) | חשבוניות ישראל, BKMVDATA, morning/iCount → Priority, CRM/ERP/BI |
| [BOTTLENECKS_AND_POSITIONING.md](./BOTTLENECKS_AND_POSITIONING.md) | Bottlenecks, AI ladder 0–1, vs Monday/Zapier |
| [COMMERCIAL_WEDGE.md](./COMMERCIAL_WEDGE.md) | בדיקת בריאות חשבוניות ₪8–15k + CPA channel |
| [FIELD_TO_OFFICE.md](./FIELD_TO_OFFICE.md) | Routing thesis; invoices as one example; WhatsApp / PWA gaps |
...
Demo login (seeded): `oren@gcs-tech.org` / `DocFlow!2026`
